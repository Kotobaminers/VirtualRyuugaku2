...
public class DataManagerOldStage implements DataManager {
...
//	public static Map<String, OldStage> mapStage = new HashMap<String, OldStage>();
//	private static String baseDirectory = DataManagerPlugin.plugin.getDataFolder() + "//" + ConfigHandlerOldStage.DIRECTORY + "//";
//	private static final String extension = ".yml";
//	private static void importStage() {
//		UtilitiesProgramming.printDebugMessage("", new Exception());
//		mapStage = new HashMap<String, OldStage>();
...
//				ConfigHandlerOldStage config = new ConfigHandlerOldStage(file);
...
//							StorageTalker.putTalker(talker);
//							listId.add(id);
//						}
//					}
//				}
//				OldStage stage = new OldStage(name, creator, listId);
//				mapStage.put(name, stage);
//			}
//		}
//	}
//	public static OldStage loadStageById(Integer id) {
//		for(OldStage stage : mapStage.values()) {
...
//	}
//	public static void addTalker(OldStage stage) {
//	}
//	public static void removeTalker(OldStage stage) {
//	}
